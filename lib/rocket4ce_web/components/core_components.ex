defmodule Rocket4ceWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(Rocket4ceWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(Rocket4ceWeb.Gettext, "errors", msg, opts)
    end
  end
